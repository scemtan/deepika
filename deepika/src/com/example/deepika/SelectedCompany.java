...
public class SelectedCompany extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) { // Bu metod uygulama açýldýðýnda çalýþtýrýlan metod.
		...
		final ProgressDialog progressDialog = ProgressDialog.show(this, "sofortpins.de","Loading...", true);
		...
		webView.setWebViewClient(new WebViewClient() {
			...
			public void onReceivedError(WebView view, int errorCode,
				...
				Toast.makeText(getApplicationContext(), "Failed to Load Page!",Toast.LENGTH_SHORT).show();
			}
